...
# tests api pour verifier l inscription et le login


class AuthTests(APITestCase):
    def setUp(self):
        # urls resolues via les names dans urls.py
        self.register_url = reverse("register")
        self.login_url = reverse("token_obtain_pair")

    def test_register_user(self):
        # on envoie un post sur register et on verifie que l utilisateur est cree
        data = {
    ...
    def test_login_user(self):
        # on cree un user puis on teste le login jwt
        ...
        # on doit recuperer access refresh et des infos user
    ...
    def test_login_wrong_password(self):
        # si le mdp est faux on attend une erreur
    ...
    def test_login_missing_passwordPers(self):
        # si on oublie le mot de passe on doit avoir une erreur de validation
