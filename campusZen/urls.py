...
from .views import PersonneViewSet, ProfessionnelViewSet, ClimatViewSet, MessageViewSet, RessourceViewSet, AvisViewSet, QuestionViewSet, StatutViewSet, ConsulteRessourceViewSet, RecuViewSet, ConsulteProViewSet, RegisterView, CustomTokenObtainPairView
